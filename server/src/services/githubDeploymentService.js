...
function stageToStep(stage) {
  const map = { github_repo_validate: 'GitHub repo validation failed', render_service_create: 'Render service creation failed', render_deploy_trigger: 'Render deploy trigger failed' };
